    ...
    return (
        <div className='que-section'>
            ...
            <div className="que1">
                ...
                <p> <strong> Answer : By using UseState, you tell React that your component needs to do something after render.It is one kind of side effect.It used for laod data,dom manupulation and else</strong>  </p>
            </div>
        </div>
    );
};
